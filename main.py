...
try: app_id = int(os.environ.get("20899529", None))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("0297693c81aac01b704702f334decddd", None)
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("7636814648:AAETQyq6mbAaVuFoI0rcdY17z3MS98qXyO0", None)
